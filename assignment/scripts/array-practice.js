...
let favoriteFoods = ['stir fry', 'pizza', 'cereal'];
...
let lastAnimalStretch = animalArray[animalArray.length - 1];
console.log('Last animal is', lastAnimalStretch);
...
let entree = 'Black bean burger';
favoriteFoods.unshift(entree);
console.log('Added entree to begining ', favoriteFoods);
...
gems[1] = 'Tourmaline';
console.log('Replaced Citrine with Tourmaline ', gems);
...
gems.sort();
gems.reverse();
console.log('Sorted reverse alphabetically  ', gems);
...
console.log('New colorful gems ', colorfulGems);
